...
public class CSPARQLStreamReceiver extends RdfStream implements Runnable {
    private InputStream in;
    Socket socket;

    public CSPARQLStreamReceiver(String iri, int portNumber) {
        super(iri);
        try {
    ...
    public void run() {
        try {
            ...
            loop:while (true) {
                ...
                //System.out.println("Putting Time: " + System.currentTimeMillis());
                //Thread.sleep(10);
            }
            System.out.println("Ending Stream: " + this.getIRI());
            CSPARQLRunningExample.streamsRunning = false;
